        ...
        <div className='flex flex-col container'>
            <div className='flex justify-between items-center'>
                ...
                <div className='w-7/12 flex flex-col gap-8'>
                    ...
                    <div className='w-full h-max rounded-3xl bg-emerald-900 text-white border-[8px] border-neutral-400 bordshadow flex gap-x-10 gap-y-7 flex-wrap justify-center py-10'>
